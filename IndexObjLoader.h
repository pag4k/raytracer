...
bool loadOBJ(const char *path, std::vector<unsigned int> &vertexIndices,
             std::vector<glm::vec3> &temp_vertices,
             std::vector<unsigned int> &normalIndices,
             std::vector<glm::vec3> &normals, std::vector<glm::vec2> &out_uvs) {
